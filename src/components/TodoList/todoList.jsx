    ...
    <ul className="w-full h-[300px] overflow-auto scroll-smooth">
      {todos.reverse().map((todo) => (
        ...
        >
          ...
          <div>
            <button
              className="w-auto p-3 text-emerald-500 bg-emerald-200 rounded-xl text-md font-medium mr-2"
              onClick={() => {
            ...
            <button
              className="w-auto p-3 text-rose-400 bg-rose-100 rounded-xl text-md font-medium"
